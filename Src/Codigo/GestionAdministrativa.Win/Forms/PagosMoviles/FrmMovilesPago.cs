...
{
    public partial class FrmMovilesPago : EditFormBase
    {
        ...
        public FrmMovilesPago(ActionFormMode mode, IGestionAdministrativaUow uow, IClock clock, Guid id)
        {
            _actionForm = mode;
            _clock = clock;
            _movilId = id;
        ...
        #region Methods
        private void FrmMovilesPago_Load(object sender, EventArgs e)
        {
